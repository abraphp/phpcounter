...
/**
 * Application\Entity\Webservers
 *
 * @ORM\Entity(repositoryClass="WebserversRepository")
 * @ORM\Table(name="webservers", uniqueConstraints={@ORM\UniqueConstraint(name="uq_webservers_name", columns={"name"})})
 */
class Webservers
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Answers", mappedBy="webservers")
